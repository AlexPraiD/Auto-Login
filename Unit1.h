...
__published:	// IDE-managed Components
	...
	void __fastcall GroupBox6MouseMove(TObject *Sender, TShiftState Shift, int X, int Y);
	...
	void __fastcall Image2MouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift,
          int X, int Y);
	void __fastcall GroupBox6MouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift,
          int X, int Y);
	...
	void __fastcall ProgressBar2MouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift,
          int X, int Y);
	void __fastcall ProgressBar1MouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift,
          int X, int Y);
